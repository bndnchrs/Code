...
if FSTD.i == OPTS.nt
    ...
    set(gcf,'windowstyle','normal','position',[0 0 pos],'paperposition',[0 0 pos],'papersize',pos,'units','inches');
    saveas(gcf,'~/Dropbox/FSTD/Manuscripts/FSTD-Code-Feedbacks/Figures/Simple-Thermo-Advect-Fracture/Simple-Thermo-Advect-Fracture.fig')
    saveas(gcf,'~/Dropbox/FSTD/Manuscripts/FSTD-Code-Feedbacks/Figures/Simple-Thermo-Advect-Fracture/Simple-Thermo-Advect-Fracture.pdf')
