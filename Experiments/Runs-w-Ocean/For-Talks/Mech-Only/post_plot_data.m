...
load /Users/Horvat/Research/FSTD-Code/Output/For-Paper/Mech-Advect/Example.mat
...
c = DIAG.FSTD.conc(1:skipper:end); 
v = DIAG.FSTD.Vtot(1:skipper:end);

for i = 1:endt-5
    
    
    pl = scatter(timer(i)/86400,c(i),100,cplots(1,:),'filled');
    pl2 = scatter(timer(i)/86400,v(i),100,cplots(2,:),'filled');
