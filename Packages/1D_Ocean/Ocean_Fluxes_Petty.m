function OCEAN = Ocean_Fluxes_Petty(OCEAN,OPTS,FSTD)
...
OCEAN.ustar_i = sqrt((OCEAN.tau/OCEAN.rho) * OCEAN.CD_i); 
OCEAN.ustar_o = sqrt((OCEAN.tau/OCEAN.rho) * OCEAN.CD_o);
OCEAN.ustar =   sqrt((OCEAN.tau/OCEAN.rho) * (FSTD.conc * OCEAN.CD_i + (1-FSTD.conc) * OCEAN.CD_o));
